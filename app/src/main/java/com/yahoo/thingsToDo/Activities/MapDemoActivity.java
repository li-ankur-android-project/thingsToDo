package com.yahoo.thingsToDo.Activities;
...
import com.yahoo.thingsToDo.MapViewFragment;
    ...
    */
	...
	public void onConnected(Bundle dataBundle) {
		...
		if (location != null) {
            ...
            MapViewFragment frag = (MapViewFragment)getSupportFragmentManager().findFragmentByTag(getMapFragmentTag());
            if (frag != null)
    ...
    // This is a big hack!!!
    private String getMapFragmentTag()
    {
    ...
    public class MainFragmentPagerAdapter extends FragmentPagerAdapter {
        ...
        final private String tabTitles[] = new String[]{"Map", "List"};
        ...
        public Fragment getItem(int position) {
            if (position == 0) {
                return MapViewFragment.newInstance("a", "b");
            }
            if (position == 1)
